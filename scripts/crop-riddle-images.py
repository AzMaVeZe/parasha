...
NEEDS_IMAGE = ['לך לך', 'וירא', 'חיי שרה', 'תולדות', 'ויגש', 'מקץ', 'צו', 'אחרי מות', 'ויקרא', 'כי תצא']
...
MANUAL = {
    ...
    # גזיר עיתון סרוק: "חידת שק המטבעות" מאת שמעון ז'יטניצקי (395,523-512,691).
    # כאן הטקסט תומלל במלואו, והתמונה נשמרת בשל ערכה ההיסטורי.
    'כי תצא': (2, 390, 518, 517, 696),
}
